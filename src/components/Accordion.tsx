    ...
    <div ref={accordionRef} className="w-full md:w-2/4 lg:w-2/6 mx-auto">
      {items.map((item, index) => (
        <div key={index} className="mb-2">
          <button
            className={`w-full text-gray-400 p-4 text-left border-2 border-gray-500 bg-gray-700 focus:outline-none rounded-2xl hover:bg-gray-800 ${activeIndex === index ? "hidden" : ""}`}
